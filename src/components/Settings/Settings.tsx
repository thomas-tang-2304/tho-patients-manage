            ...
            <div className={`mx-2 flex flex-col gap-2 w-auto`}>
                ...
                <form action="" className="flex flex-col justify-between gap-3">
                    <div className="form-1">
                        <label htmlFor=""><strong>Form amount</strong></label>
                    ...
                    <div className="form-2">
                        ...
                        <div className="mb-3 social-input-link">
                            <label className='py-2 mr-4' htmlFor="">"Facebook icon"</label>
                            <input className='w-64 p-2 border-2' type="text" placeholder='http://facebook.com/fanpage' />
                        </div>
                        <div className="mb-3 social-input-link">
                            <label className='py-2 mr-4' htmlFor="">"Facebook icon"</label>
                            <input className='w-64 p-2 border-2' type="text" placeholder='http://youtube.com/channel' />
                    ...
                    <div className="form-3">
                        ...
                        <div className='pb-1 mb-3 border-b-2'>
                            ...
                            <label htmlFor=""><strong>Youtube Videos</strong></label>
                        </div>
                        <textarea className='p-2 border-2' name="" id="" cols={70} rows={10}>
                        </textarea>
                    </div>
